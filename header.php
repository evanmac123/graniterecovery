	...
	<header class="site-header" role="banner">
		...
		<nav class="site-navigation top-bar" role="navigation">
			...
			<div class="top-bar-right">
				<form role="search" method="get" id="searchform" class="top-bar-right-search" action="//graniterecoverycenters.com/">
				...
				<div class="top-bar-right-share">
					<div class="share-social">
						<div class="share-icon">
							<img class="icons"src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/icons/share.svg">
						</div>
						<div class="share-bar">
